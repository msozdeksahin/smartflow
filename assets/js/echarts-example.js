(function (factory) {
  ...
  const basicGaugeChartInit2 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-basic-gauge-chart-example2');
  ...
  const basicGaugeChartInit3 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-basic-gauge-chart-example3');
        ...
        series: [
          {
            ...
            axisLine: {
              lineStyle: {
                width: 6,
                color: [
                  [0.125, getColor('danger')],
                  [0.25, getColor('warning')],
                  [0.375, getColor('white')],
                  [0.5, getColor('white')],
                  [0.625, getColor('white')],
                  [0.75, getColor('white')],
                  [0.875, getColor('warning')],
                  [1, getColor('danger')]
                ]
              }
            },
  ...
  const gaugeGradeChartInit2 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-gauge-grade-chart-example2');
  ...
  const gaugeGradeChartInit3 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-gauge-grade-chart-example3');
  ...
  const gaugeGradeChartInit4 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-gauge-grade-chart-example4');
  ...
  const gaugeGradeChartInit5 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-gauge-grade-chart-example5');
  ...
  const gaugeGradeChartInit6 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector('.echart-gauge-grade-chart-example6');
  ...
  docReady(basicGaugeChartInit2);
  docReady(basicGaugeChartInit3);
  ...
  docReady(gaugeGradeChartInit2);
  docReady(gaugeGradeChartInit3);
  docReady(gaugeGradeChartInit4);
  docReady(gaugeGradeChartInit5);
  docReady(gaugeGradeChartInit6);
